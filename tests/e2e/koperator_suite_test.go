...
var _ = ginkgo.When("Testing e2e test altogether", ginkgo.Ordered, func() {
	...
	testUninstallZookeeperCluster()
	testInstallZookeeperCluster()
	testInstallKafkaCluster("../../config/samples/simplekafkacluster_multidisk.yaml")
	testMultiDiskRemoval()
	testUninstallKafkaCluster()
	testUninstallZookeeperCluster()
	testInstallZookeeperCluster()
	testInstallKafkaCluster("../../config/samples/simplekafkacluster_twodisk.yaml")
	testAddThenRemoveMiddleDisk()
	testUninstallKafkaCluster()
	testUninstallZookeeperCluster()
	// TODO: Uncomment these tests when we the disk swap feature is implemented.
	// testInstallZookeeperCluster()
	// testInstallKafkaCluster("../../config/samples/simplekafkacluster_twodisk.yaml")
	// testDiskSwap()
	// testUninstallKafkaCluster()
