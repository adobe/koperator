...
const (
	...
	CertManagerVersion = "v1.20.1" // renovate: datasource=helm depName=cert-manager registryUrl=https://charts.jetstack.io
	...
	PrometheusOperatorVersion = "83.4.0" // renovate: datasource=helm depName=kube-prometheus-stack registryUrl=https://prometheus-community.github.io/helm-charts
