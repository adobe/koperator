...
const (
	...
	CertManagerVersion = "v1.20.0" // renovate: datasource=helm depName=cert-manager registryUrl=https://charts.jetstack.io

	// ContourVersion is the version of Contour ingress controller Helm chart
	ContourVersion = "0.3.0" // renovate: datasource=helm depName=contour registryUrl=https://projectcontour.github.io/helm-charts
