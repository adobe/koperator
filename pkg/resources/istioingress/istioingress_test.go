...
func TestLabelsForIstioIngress(t *testing.T) {
	tests := []struct {
		name           string
		crName         string
		eLName         string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			labels := labelsForIstioIngress(tt.crName, tt.eLName, tt.istioRevision)
			assert.Equal(t, tt.expectedLabels, labels)
		})
	}
}

func TestLabelsForIstioIngressWithoutEListenerName(t *testing.T) {
	tests := []struct {
		name           string
		crName         string
		istioRevision  string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			labels := labelsForIstioIngressWithoutEListenerName(tt.crName, tt.istioRevision)
			assert.Equal(t, tt.expectedLabels, labels)
		})
	}
}

func TestReconcile_WithIstioIngressController(t *testing.T) {
	mockClient := &MockClient{}
	cluster := &v1beta1.KafkaCluster{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "test-cluster",
...
func TestReconcile_WithRemoveUnusedIngressResources(t *testing.T) {
	...
	cluster := &v1beta1.KafkaCluster{
		...
		Spec: v1beta1.KafkaClusterSpec{
			...
			IngressController:            "nginx", // Not istioingress
